        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="md:grid grid grid-cols-3 md:grid-cols-3">
              <div>
                ...
                <ul className=" space-y-8 text-gray-800 text-xs md:text-xs">
                  ...
                  <li className="mb-2">Football Field</li>
                  <li className="mb-2">Swimming Pool</li>
                  <li className="mb-2">Gym & Fitness Canter</li>
                  <li className="mb-2">Multi-purpose Hall</li>
                  <li className="mb-2">
                    Sauna & Relaxation Zone
                  </li>
                  <li className="mb-2">Locker Rooms</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <div className="flex md:text-sm  p-1 w-24 text-xs gap-2 md:w-24 items-center border border-gray-800 rounded-full   text-gray-800">
                    ...
                    <span className="md:text-sm md:-m-1"> Youtube </span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex md:flex-row items-center md:items-start justify-between gap-4">
            ...
            <div className="flex items-center gap-3 text-gray-800">
              <a
                href="mailto:info@loversport.com"
                className="text-sm"
              >
