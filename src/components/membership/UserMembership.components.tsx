...
const UserMembership:FC = () => {
  ...
  return (
 <>
      <section className="bg-black h-1/3 mb-10 m-4 flex items-center justify-center rounded-2xl p-4">
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-center gap-8">
          <div className="w-full md:w-1/2">
            <img
              src={membershipImg}
              alt="Membership"
              className="w-full h-86 object-cover rounded-3xl"
            />
          </div>

          <div className="w-full md:w-full">
            <div className="flex gap-4 mb-6">
              <button className="px-6 p-3 md:py-4 border border-white text-white rounded-full text-sm font-medium">
                Membership
              </button>
              <button className="px-6 py-3 bg-gray-200 text-black rounded-full text-sm font-medium">
                Newsletter
              </button>
            </div>
            ...
            <div className="relative w-full md:w-1/2">
              <input
                ...
                className="w-full px-6 py-4 pr-14 rounded-full bg-white text-black placeholder-text-white outline-none"
              />
              <button
                type="button"
